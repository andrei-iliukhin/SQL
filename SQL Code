# Problem 1: Solution in SQL (A breakdown between male and female employees)
...
# Problem 2: Solution in SQL (Number of managers per department )
...
# Problem 3: Solution in SQL (Average annual employee salary)
...
#Problem 4: Solution in SQL (Average employee salary (since 1990))
